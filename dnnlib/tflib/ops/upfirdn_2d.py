...
def upfirdn_2d(x, k, upx=1, upy=1, downx=1, downy=1, padx0=0, padx1=0, pady0=0, pady1=0, impl=ref_type):
...
def filter_2d(x, k, gain=1, data_format='NCHW', impl=ref_type):
...
def upsample_2d(x, k=None, factor=2, gain=1, data_format='NCHW', impl=ref_type):
...
def downsample_2d(x, k=None, factor=2, gain=1, data_format='NCHW', impl=ref_type):
...
def upsample_conv_2d(x, w, k=None, factor=2, gain=1, data_format='NCHW', impl=ref_type):
    ...
    # Execute.
    x = tf.nn.conv2d_transpose(x, w, output_shape=output_shape, strides=stride, padding='VALID',
...
def conv_downsample_2d(x, w, k=None, factor=2, gain=1, data_format='NCHW', impl=ref_type):
...
def _simple_upfirdn_2d(x, k, up=1, down=1, pad0=0, pad1=0, data_format='NCHW', impl=ref_type):
